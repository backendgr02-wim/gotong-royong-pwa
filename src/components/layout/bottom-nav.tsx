...
const tabs: Tab[] = [
  ...
  { href: "/aksi", label: "Aksi", icon: Plus, center: true },
        ...
        if (t.center) {
          return (
            <Link
              ...
              href={t.href}
              aria-label={t.label}
              className="-mt-7 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-white shadow-lg shadow-primary/30 active:scale-95"
            >
              <Icon size={26} />
            </Link>
          );
